...
const p = (folder: string, file: string) =>
  `/music/${folder}/${encodeURIComponent(file)}`;
const lf = (file: string) =>
  `/music/lyrics/${encodeURIComponent(file)}`;

const TRACKS: Track[] = [
  { id: 1,  title: "Instrumental 1",         artist: "AI and Coffee", src: p("instrumental", "AI and Coffee - Instrumental 1.mp3"),       type: "instrumental" },
  { id: 2,  title: "Instrumental v2",        artist: "AI and Coffee", src: p("instrumental", "AI and Coffee - Instrumental v2.mp3"),      type: "instrumental" },
  { id: 3,  title: "Midnight Compile",       artist: "AI and Coffee", src: p("vocal", "AI and Coffee - Midnight Compile.mp3"),            type: "vocal", lyricsFile: lf("AI and Coffee - Midnight Compile.rtf")       },
  { id: 4,  title: "Midnight Compile v2",    artist: "AI and Coffee", src: p("vocal", "AI and Coffee - Midnight Compile v2.mp3"),         type: "vocal", lyricsFile: lf("AI and Coffee - Midnight Compile v2.rtf")    },
  { id: 5,  title: "Coffee and Code",        artist: "AI and Coffee", src: p("vocal", "Coffee and Code.mp3"),                            type: "vocal", lyricsFile: lf("AI and Coffee - Coffee and Code.rtf")        },
  { id: 6,  title: "Coffee and Code v2",     artist: "AI and Coffee", src: p("vocal", "Coffee and Code v2.mp3"),                         type: "vocal", lyricsFile: lf("AI and Coffee - Coffee and Code v2.rtf")     },
  { id: 7,  title: "Coffee and Comments",    artist: "AI and Coffee", src: p("vocal", "Coffee and Comments.mp3"),                        type: "vocal", lyricsFile: lf("AI and Coffee - Coffee and Comments.rtf")    },
  { id: 8,  title: "Coffee and Comments v2", artist: "AI and Coffee", src: p("vocal", "Coffee and Comments v2.mp3"),                     type: "vocal", lyricsFile: lf("AI and Coffee - Coffee and Comments v2.rtf") },
  { id: 9,  title: "Coffee and Compile",     artist: "AI and Coffee", src: p("vocal", "Coffee and Compile.mp3"),                         type: "vocal", lyricsFile: lf("AI and Coffee - Coffee and Compile.rtf")     },
  { id: 10, title: "Coffee and Compile v2",  artist: "AI and Coffee", src: p("vocal", "Coffee and Compile v2.mp3"),                      type: "vocal", lyricsFile: lf("AI and Coffee - Coffee and Compile v2.rtf")  },
  { id: 11, title: "Halfway Save",           artist: "AI and Coffee", src: p("vocal", "Halfway Save.mp3"),                               type: "vocal", lyricsFile: lf("AI and Coffee - Halfway Save.rtf")          },
  { id: 12, title: "Halfway Save v2",        artist: "AI and Coffee", src: p("vocal", "Halfway Save v2.mp3"),                            type: "vocal", lyricsFile: lf("AI and Coffee - Halfway Save v2.rtf")       },
];
...
function parseRtf(rtf: string): string {
  const start = rtf.indexOf("\\cf0");
  const content = start >= 0 ? rtf.slice(start + 4) : rtf;
  return content
    .replace(/\\'([0-9a-fA-F]{2})/g, (_, hex) =>
      W1252[hex.toLowerCase()] ?? String.fromCharCode(parseInt(hex, 16))
    )
    .replace(/\\\n/g, "\n")
    .replace(/\\[a-z]+\-?\d*\s?/gi, "")
    .replace(/\\\*/g, "")
...
export default function Vibes() {
  ...
  useEffect(() => {
    ...
    fetch(track.lyricsFile)
      .then((r) => r.text())
      .then((rtf) => { setLyrics(parseRtf(rtf)); setLyricsLoading(false); })
      .catch(() => setLyricsLoading(false));
  }, [currentIndex, track.lyricsFile]);
              ...
              <div>
                ...
                {showLyrics && (
                  <div className="border border-zinc-400/30 bg-white/20 p-4 max-h-72 overflow-y-auto">
                    {lyricsLoading ? (
                      <p className="text-[10px] text-zinc-400 uppercase tracking-widest animate-pulse">loading...</p>
                    ) : lyrics ? (
                      <pre className="text-xs text-zinc-600 leading-relaxed whitespace-pre-wrap font-mono">{lyrics}</pre>
                    ) : (
                      <p className="text-[10px] text-zinc-400 uppercase tracking-widest">no lyrics found</p>
                    )}
                  </div>
                )}
              </div>
